...
The HR round assesses your personality, communication skills, cultural fit, and behavioral competencies. IBM values innovation, collaboration, and dedication to client success.
...
**Situation:** I led the technical team for MaJIStic Annual Cultural Fest 2024-26 at JIS College.

**Task:** Coordinated technical arrangements including event registration, audio-visual setup, and participant management.

**Action:**

- Delegated responsibilities based on team members' strengths
- Conducted regular meetings to track progress
...
**Situation:** In my early coding journey, I submitted a college project without thorough testing.

**Task:** The application crashed during the professor's demonstration due to an unhandled edge case.
...
## Section 3: IBM-Specific Questions
